...
var yorks = ['망스터', '좃스터', '좆스터', '씨발롬', '씨발놈', '씨발련', '씨발년', '시발롬', '시발놈', '시발년', '시발련', 'ㅅㅂ', '시발', '씨발', 'sibal', '시부랄', '쉬벌', '씨펄', 'C Perl', '쉬펄', '쒸펄', '시벌', '씨벌', 'ㅂㅅ', '병신', '비영신', '븅신', '피융신', '비융신', '개새끼', '개새', '개년', '상년', '쌍년', '썅년', '썅노무새끼', '지랄', '염병', '옘병', '존나', '줫나', '좆', '좃'];

exports.default = function (controller) {
  // 서장님 찾기
  controller.hears([new RegExp('(' + yorks.join('|') + ')', 'g')], ['direct_message'], function (bot, message) {
    var word = _lodash2.default.uniq(message.match).join('? ');
